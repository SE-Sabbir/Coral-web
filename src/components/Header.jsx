        ...
        <div className='container'>
            <div className="header_row flex items-center justify-between pt-[31px] pb-[25px] border-b border-[#E3E3E3]">
                ...
                <div className="header_btn_col flex gap-[22px]">
                    <Link className='flex items-center gap-[8px] text-lg font-normal font-roboto text-primary' to ={'#'}><FaUser/>Account</Link>
                    <Link className='flex items-center gap-[8px] text-lg font-normal font-roboto text-primary' to ={'#'}><FaBagShopping/>Shoping</Link>
                </div>
            </div>
        </div>
        {/* -------Search Overlay */}
