        ...
        <div className="container">
            <div className="banner_row flex items-center flex-wrap justify-center lg:justify-between">
                <div className="banner_text">
                    ...
                    <h2 className=' text-[20px] lg:text-[30px] font-roboto font-normal leading-8 lg:leading-[55px] text-black capitalize w-full lg:w-[682px] pt-[52px] pb-[66px] '>you can explore ans shop many differnt collection
                        from various barands here.</h2>
                    <Link className=' flex items-center justify-center w-[100%] scale-80 lg:scale-100 lg:w-[223px] h-[72px] text-[29px] font-roboto font-normal text-[#ffffff] gap-[8px] bg-[#000000] ' to={'#'}><FaBagShopping/>shop now</Link>
                </div>
                <div className="banner_img_group flex items-center relative pr-5 scale-[75%] lg:scale-[100%] ">
                    ...
                    <div className="image_border w-[424px] h-[542px] border-2 border-[#00000025] rounded-tl-[40%] rounded-br-[40%] left-[18px] top-[20px] absolute "></div>
                </div>
            </div>
        </div>
